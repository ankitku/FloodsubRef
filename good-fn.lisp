...
(property prop=pending-!in-seen-s-fn (s :s-fn p :peer m :mssg)
  :h (^ (mget p s)
...
(property prop=pending-!in-seen-s-fn1 (s :s-fn m :mssg)
  :check-contracts? nil
...
(property prop=pending-!in-seen-s-fn4 (s :s-fn p :peer topics :lot)
  :h (^ (mget p s)
        (pending-!in-seen-s-fn s))
...
(property prop=pending-!in-seen-s-fn5 (s :s-fn p :peer topics :lot)
  :h (^ (mget p s)
        (pending-!in-seen-s-fn s))
...
(property prop=pending-!in-seen-s-fn6 (s :s-fn p :peer)
  :h (^ (mget p s)
        (pending-!in-seen-s-fn s))
...
(property prop=pending-!in-seen-s-fn7 (p :peer pubs subs :lot nbrs :lop s :s-fn)
  :h (^ (! (mget p s))
        (! (in p nbrs))
        (pending-!in-seen-s-fn s))
...
(property prop=pending-!in-seen-s-fn-forward (p :peer m :mssg s :s-fn)
  :h (^ (mget p s)
        (in m (mget :pending (mget p s)))
        (pending-!in-seen-s-fn s))
...
(property prop=p!in-nsubs-s-fn-produce (s :s-fn m :mssg)
  :check-contracts? nil
  :h (^ (p!in-nsubs-s-fn s)
        (produce-fn-pre m s))
...
(property prop=p!in-nsubs-s-fn-subscribe (p :peer topics :lot s :s-fn)
  :h (^ (mget p s)
        (p!in-nsubs-s-fn s))
...
(property prop=p!in-nsubs-s-fn-unsubscribe (p :peer topics :lot s :s-fn)
  :h (^ (mget p s)
        (p!in-nsubs-s-fn s))
...
(property prop=p!in-nsubs-s-fn-join
  (p :peer pubs subs :lot nbrs :lop s :s-fn)
  :h (^ (! (mget p s))
        (! (in p nbrs))
        (p!in-nsubs-s-fn s))
...
(property prop=p!in-nsubs-s-fn-forward-help
  (p :peer nbrs :lop m :mssg s :s-fn)
  :h (^ (p!in-nsubs-s-fn s)
        (! (in p nbrs)))
...
(property prop=p!in-nsubs-s-fn-forward (p :peer m :mssg s :s-fn)
  :h (^ (mget p s)
        (in m (mget :pending (mget p s)))
        (p!in-nsubs-s-fn s))
...
(property prop=pending-origins-s-fn (m :mssg s :s-fn)
...
(property prop=pending-origins-s-fn-produce (s :s-fn m :mssg)
...
(property prop=pending-origins-s-fn-subscribe (s :s-fn p :peer topics :lot)
  :h (^ (mget p s)
        (pending-origins-s-fn s))
...
(property prop=pending-origins-s-fn-unsubscribe (s :s-fn p :peer topics :lot)
  :h (^ (mget p s)
        (pending-origins-s-fn s))
...
(property prop=pending-origins-s-fn-leave
  (p :peer ms :lom s :s-fn)
  :h (^ (mget p s)
        (pending-origins-s-fn-help ms s))
  (pending-origins-s-fn-help ms (join-fn p s)))
...
(property prop=pending-origins-s-fn-update-forwarder-help
  ...
  (:pro
   ...
   (:dv 2) (:r update-forwarder-fn) :s :up
   (:casesplit (equal (car (car s)) p)) :s
   ...
   (:claim (! (<< (mget :or (car ms)) p)))
   (:claim (== (mget :pubs (forwarder-new-pst (cdr (car s)) m))
               (mget :pubs (cdr (car s)))))
